...
async function updateProfile(req, res) {
  try {
    ...
    const { headline, bio, skills, experience, projects, github, linkedin } =
      req.body;
    const updateData = {};
...
async function candidateProfile(req, res) {
  try {
    ...
    const profile = await candidateModel
      .findOne({ owner: candidateId })
...
module.exports = { updateProfile, getProfile, candidateProfile };
